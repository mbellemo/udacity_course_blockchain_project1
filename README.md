...
2. To make sure your application is working fine and it creates the Genesis Block you can use POSTMAN to request the Genesis block:
    ![Request: http://localhost:8000/block/0 ](img/genesis_block.png)
3. Make your first request of ownership sending your wallet address:
    ![Request: http://localhost:8000/requestValidation ](img/request_validation.png)
4. Sign the message with your Wallet:
    ![Use the Wallet to sign a message](img/sign_with_wallet.png)
5. Submit your Star
     ![Request: http://localhost:8000/submitstar](img/submit_star.png)
6. Retrieve Stars owned by me
    ![Request: http://localhost:8000/blocks/<WALLET_ADDRESS>](img/get_stars.png)